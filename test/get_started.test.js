// Here we will test our server -- and it's very first route

// const App = require("../server");

// describe("App", () => {
//   describe("get started", () => {
//     it ("should return the notes.html file for the /notes route", async () =>
//     {
...
//     console.log("The test reveals: the url is: " + res.url);
